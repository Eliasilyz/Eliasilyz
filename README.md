...
I build practical software systems using **JavaScript, TypeScript, Node.js, APIs, databases, and AI**.

My work focuses on **full-stack applications, backend systems, and automation**.

### Tech Stack

- **Languages:** JavaScript · TypeScript · HTML · CSS
- **Backend:** Node.js · Express.js · REST API · WebSocket · Golang
- **Database:** MongoDB · SQLite · PostgreSQL · MySQL · Redis
- **Tools:** Git · GitHub · Linux · Vercel · VPS · Docker · Nginx
- **AI & APIs:** LLM APIs · MCP · Telegram · Discord · WhatsApp
...
- **LinkedIn:** [farel-hanafi](https://linkedin.com/in/farel-hanafi/)
...
<div aligh="center">
 <p align="center">
  <a href="https://www.npmjs.com/package/farelhanafi">
    <img src="https://img.shields.io/badge/npx-farelhanafi-C12127?style=for-the-badge&logo=npm&logoColor=white" alt="committers.top private rank" />
  </a>
